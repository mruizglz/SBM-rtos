...
- `B2/` - Ejemplos de uso de CMSIS-RTOS v2 (proyectos en Keil µVision y Visual Studio Code) y material de la presentación de CMSIS-RTOS2.
  - `ejemplothreads/`, `ejemplothreads-flags/`, `ejemplothreads-queues/`, `ejemplothreads-timers/` - Código fuente (`src/`), proyecto Keil (`keil/`) y proyecto de Visual Studio Code/CMSIS (`vc/`) de cada ejemplo.
...
## Máquina Virtual con Ubuntu 24.04, Visual Studio Code y CMSIS Extension ya instalados
...
code
```
Esto carga las variables necesarias para que visual code funcione correctamente con las extensiones de CMSIS
