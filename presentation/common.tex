...
\tikz\node[opacity=0.095, rotate = 0] {\includegraphics[scale=0.5]{UPM-logo.png}};}
%{\includegraphics[height=1in,width=1in]{TAM-Logo.png}};}


\title[Universidad Politécnica de Madrid]{Introducción a CMSIS-RTOS v2}
...
{\textbf{Sistemas Basados en Microprocesador}, ETSI Sistemas de Telecomunicación \\ Formato Latex copiado parcialmente de Bootlin \\
