...
void ThDisplay (void *argument){
    ...
    \end{columns}
    \begin{itemize}
        \item Es aconsejable crear un fichero de cabecera donde se deberán declarar la función de inicio para poder ser utilizados por otros módulos del software
    \end{itemize}
\end{frame}
...
for (;;){
    ...
    \item Timers virtuales
        \begin{itemize}
            \item Ejecutan una función (\textbf{callback}) cuando el tiempo expira
